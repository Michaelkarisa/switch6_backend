...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // ── match_views ───────────────────────────────────────────────────────
        // MatchViewService → WHERE match_id; viewer counts group by match_id
        Schema::table('match_views', function (Blueprint $table) {
            $table->index('match_id', 'idx_match_views_match_id');
            $table->index('user_id',  'idx_match_views_user_id');
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('match_views', function (Blueprint $table) {
            $table->dropIndex('idx_match_views_match_id');
            $table->dropIndex('idx_match_views_user_id');
        });

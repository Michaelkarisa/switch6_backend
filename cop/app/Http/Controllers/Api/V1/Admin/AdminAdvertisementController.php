...
class AdminAdvertisementController extends Controller
{
    ...
    public function restore(Request $request, string $id): JsonResponse
    {
        ...
        return Api::success($this->service->restore($ad, $request), 'Advertisement restored successfully');
    }

    public function forceDestroy(Request $request, string $id): JsonResponse
    {
        $ad = Advertisement::onlyTrashed()->findOrFail($id);
        $this->service->forceDelete($ad, $request);
        return Api::success(null, 'Advertisement permanently deleted');
    }
